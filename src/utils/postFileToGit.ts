...
const path = 'settings'
const personalAccessTokenEncoded =
  'Z2l0aHViX3BhdF8xMUFIR1ZDNUkwUWVLVmdEdWs5MmNnXzYxSFRmU1drMWFsYWRTYU1uSTlXMkxJdjV0ZzdpM2ZXZlRQOXBpUlVjSUlFNjVOVFZTWUlkRjE0Yldy'
