...
const line = () => (
  ...
  >
    <line
      ...
      x2="449.5"
      y2="0.5"
      stroke="url(#paint0_linear_1_602)"
      strokeLinecap="round"
    />
    <defs>
      <linearGradient
        id="paint0_linear_1_602"
        x1="450"
        y1="1.99979"
        x2="0"
        y2="1.99979"
      ...
      <div className="movie-card">
        ...
        <div className="show-description-container">
          <div className="movie-time-and-auditorium">
            <span className="show-time">{`${showDate
              .getHours()
          ...
          <div>
            <div className="show-genres-and-warn">
              <span className="show-genres">{`${show.Genres}`}</span>
              {warning && (
                <span className="show-warn">{`${prepareWarning(show)}`}</span>
              )}
            </div>
          </div>
